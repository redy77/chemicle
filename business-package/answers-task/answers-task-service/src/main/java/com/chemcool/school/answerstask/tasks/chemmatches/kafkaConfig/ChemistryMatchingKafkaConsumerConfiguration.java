package com.chemcool.school.answerstask.tasks.chemmatches.kafkaConfig;
...
public class ChemistryMatchingKafkaConsumerConfiguration {
    ...
    public static final String TRUSTED_PACKAGES =  "com.chemcool.school.answerstask.tasks.chemmatches.domain";
