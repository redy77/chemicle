package com.chemcool.school.tasks.infrastructure.chemequations.configuration;

import com.chemcool.school.tasks.infrastructure.chemequations.configuration.properties.ChemEquationsTaskDeserializer;
import com.chemcool.school.tasks.infrastructure.chemequations.configuration.properties.KafkaProperties;
...
public class KafkaChemEquationsConsumerConfiguration {
    ...
    private final String TRUSTED_PACKAGES = "com/chemcool/school/tasks/chemequations/domain";
