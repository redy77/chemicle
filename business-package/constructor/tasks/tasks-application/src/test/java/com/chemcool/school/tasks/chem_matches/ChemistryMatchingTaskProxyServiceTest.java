package com.chemcool.school.tasks.chem_matches;

import com.chemcool.school.tasks.chem_equation.TasksApplication;
...
import com.chemcool.school.tasks.service.chemmatches.ChemistryMatchingTaskProxyService;
...
class ChemistryMatchingTaskProxyServiceTest {
    ...
    @BeforeEach
    public void add() {
        List<CoupleForMatching> coupleForMatchings = new ArrayList<>();

        coupleForMatchings.add(new CoupleForMatching("He", "Гелий"));
        coupleForMatchings.add(new CoupleForMatching("H", "Водород"));
        coupleForMatchings.add(new CoupleForMatching("O", "Кислород"));
        coupleForMatchings.add(new CoupleForMatching("C", "Углерод"));
    ...
    void getAll() {
        timer(1000);
        List<ChemistryMatchingTask> tasks = service.getAll();
