...
import com.chemcool.school.theory.configuration.properties.ChemistryLessonDeserializer;
...
public class KafkaConsumerConfiguration {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        prop.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ChemistryLessonDeserializer.class);
